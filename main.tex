...
pdftitle={The RoboRoach},
pdfsubject={weapons, robotics, and control engineering},
pdfkeywords={Blaberus, Periplaneta, robot, biomechanics, neuromechanics, neurophysiology}
}
...
\title{The RoboRoach}
\author{Midshipman 1/C Alexis Pak and Midshipman 1/C Brooklyn Pritchard\thanks{Authors are with the Department of Weapons, Robotics, and Control Engineering at the United States Naval Academy. Addresses for correspondence \emph{m21xxxx} and \emph{m21xxxx} at usna dot edu.}}
\date{\today}
...
\begin{IEEEkeywords}
\Blaberus, \Periplaneta, robot, biomechanics, neuromechanics, neurophysiology
\end{IEEEkeywords}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.25]{\myroot/figures/lab.JPEG}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.55]{\myroot/figures/PCC.JPG}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.4]{\myroot/figures/metrics.JPG}
\caption{Metrics}
\label{fig:metrics}
\end{figure}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.45]{\myroot/figures/relatedwork.JPG}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.45]{\myroot/figures/fbd1.JPG}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.45]{\myroot/figures/fbd2.JPG}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.45]{\myroot/figures/fbd3.JPG}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.5]{\myroot/figures/decisionmatrix.JPG}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.4]{\myroot/figures/morph.JPG}
\caption{Morph Chart}
\label{fig:morph}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[scale=0.65]{\myroot/figures/budget.JPG}
\caption{Summary of Parts list}
\label{fig:budget}
\end{figure}

\begin{figure}
\includegraphics[scale=0.50]{\myroot/figures/partlist.JPG}
\caption{Summary of Parts list}
\label{fig:partlist}
\end{figure}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.60]{\myroot/figures/mech.JPG}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.60]{\myroot/figures/BBschematic.JPG}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.4]{\myroot/figures/TPschematic.JPG}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.4]{\myroot/figures/Newbattery.JPG}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.35]{\myroot/figures/EESCHEMA.JPG}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.5]{\myroot/figures/myboard.JPG}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.5]{\myroot/figures/my3dmodel.JPG}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.4]{\myroot/figures/pseudocode.JPG}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.6]{\myroot/figures/TIMELINE.JPG}
